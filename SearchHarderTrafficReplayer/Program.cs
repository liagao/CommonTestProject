namespace SearchHarderTrafficReplayer
{
    ...
    internal class Program
    {
        ...
        private static int RunInHours = 2;
        ...
        static void Main(string[] args)
        {
            ...
            Task.Run(() => new QueryEmitter(SHNativeEndpoint, shnativeMessageList, 1000 / QPS, RunInHours).Start());
            Task.Run(() => new QueryEmitter(SHLangToolsEndpoint, shlangtoolsMessageList, 1000 / QPS, RunInHours).Start());
